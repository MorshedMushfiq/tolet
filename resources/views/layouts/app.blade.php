	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="" class="nav-link">Apartment Room</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('logout.user')}}" aria-expanded="false">
            ...
            @else
            <li class="nav-item">
              <a class="nav-link" href="{{route('admin.login')}}" aria-expanded="false">
                
                <span class="hide-menu">Login</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{route('admin.register')}}" aria-expanded="false">
